...
*SancesApi* | [**cours_seances_id_delete**](docs/SancesApi.md#cours_seances_id_delete) | **DELETE** /cours/seances/{id} | Supprime une séance
*SancesApi* | [**cours_seances_id_get**](docs/SancesApi.md#cours_seances_id_get) | **GET** /cours/seances/{id} | Retourne les infos sur la séance
*SancesApi* | [**cours_seances_id_post**](docs/SancesApi.md#cours_seances_id_post) | **POST** /cours/seances/{id} | Crée une nouvelle séance
